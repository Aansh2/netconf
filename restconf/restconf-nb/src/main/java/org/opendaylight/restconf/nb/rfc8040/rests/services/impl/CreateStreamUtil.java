...
public final class CreateStreamUtil {
    ...
    public static DOMRpcResult createDeviceNotificationListenerOnMountPoint(
        ...
        final DOMNotificationService domeDomNotificationService = mountPoint.getService(DOMNotificationService.class)
                        .orElseThrow(() -> new RestconfDocumentedException("Mount point not available",
                                ErrorType.APPLICATION, ErrorTag.OPERATION_FAILED));
        final DOMSchemaService domSchemaService = mountPoint.getService(DOMSchemaService.class)
                .orElseThrow(() -> new RestconfDocumentedException("Mount point not available",
                        ErrorType.APPLICATION, ErrorTag.OPERATION_FAILED));
        final EffectiveModelContext effectiveModelContext = domSchemaService.getGlobalContext();
        ...
        notificationListenerAdapter.listen(domeDomNotificationService, absolutes);
